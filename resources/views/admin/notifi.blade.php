            ...
            <table class="table table-bordered ">
                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td><center> <a href = "{{ URL::to('admin/users/notification/'.$user->id) }}" class="btn btn-danger"><span class="glyphicon glyphicon-ok"></span> Activate</a>
                                <a href = "{{ action('UserController@deleteNotification', $user->id) }}" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a></center></td>
                    </tr>
                @endforeach
                </tbody>
            </table>

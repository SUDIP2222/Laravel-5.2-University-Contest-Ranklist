            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['url'=>['/admin/contests'],'class'=>'form-horizontal']) !!}
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('full_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!!Form::select('full_name',$users,null,['class'=>'form-control','multiple'])!!}
                        ...
                        <div class="form-group{{ $errors->has('contest_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('contest_name',null,['class'=>'form-control','placeholder'=>'Enter Contest Name']) !!}
                        ...
                        <div class="form-group{{ $errors->has('penalty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::number('penalty',null,['class'=>'form-control','placeholder'=>'Enter Contest Penalty']) !!}
                        ...
                        <div class="form-group{{ $errors->has('solve') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::number('solve',null,['class'=>'form-control','placeholder'=>'Enter Contest Solve']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> Contest Add
                                </button>
                            </div>
                        </div>
                        {!! Form::close() !!}

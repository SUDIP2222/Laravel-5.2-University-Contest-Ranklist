...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container" >
        <div class="navbar-header" >
            <a class="navbar-brand fn" href="{{ url('home') }}"><span class="glyphicon glyphicon-list-alt"></span> RankList </a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    ...
                    @if(Auth::user()->is_a==='admin')
                        <li><a href="{{ url('admin/users') }}">Deshboard</a></li>
                    @endif
                        <li><a href="{{ url('home') }}">Home</a></li>
                        <li><a href="{{ url('user/profile') }}">Profile</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <span class="glyphicon glyphicon-user"></span> {{ Auth::user()->fname }} <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu" role="menu">

                            <li><a href="{{ url('/profile/addinfo') }}"><i class="glyphicon glyphicon-save"></i> Add Information</a></li>
                            <li><a href="{{ url('/edit-profile') }}"><i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>
                            <li><a href="{{ url('/edit-profile') }}"><i class="glyphicon glyphicon-edit"></i> Edit profile</a></li>
